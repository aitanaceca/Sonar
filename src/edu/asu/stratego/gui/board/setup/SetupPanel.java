...
public class SetupPanel {
    ...
    private final static Object    updateReadyStatus = new Object();
    ...
    public SetupPanel() {
        ...
        panelForSetUp.setMaxHeight(UNIT * 4);
        ...
        setupTimer.setFont(Font.font(letterType, UNIT / 3));
    ...
    public static void finishSetup() {
        ...
        synchronized (setupPieces) {
            ...
            panelForSetUp.add(readyLabel, 0, 1);
